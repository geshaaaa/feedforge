          ...
          <div className="flex items-center md:ml-auto">
            {socialIcons.map((social, index) => (
              <a
                key={index}
                href="#"
                className="flex h-8 w-8 items-center justify-center border border-r-0 border-gray-200 bg-gray-50 text-gray-600 transition-all duration-300 first:rounded-l-lg last:rounded-r-lg last:border-r hover:border-teal hover:bg-teal/10 hover:text-teal"
            ...
            <ul className="space-y-0.5">
              {footerLinks.product.map((link, index) => (
                <li key={index}>
                  <a
                    href="#"
                    className="text-xs text-gray-900 transition-colors duration-300 hover:text-teal"
                  >
                    {link}
                  </a>
                </li>
                ...
                return (
                  <li key={index}>
                    <a
                      href="#"
                      className={`text-xs text-gray-900 transition-colors duration-300 hover:text-teal ${
                        isUnderlined ? 'underline decoration-teal underline-offset-2' : ''
                      }`}
                    >
                      {linkText}
                    </a>
