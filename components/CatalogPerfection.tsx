      ...
      <div className="mx-auto max-w-7xl px-6 py-12 lg:py-16">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="flex flex-col justify-center">
            ...
            {/* Why it matters card */}
            <div className="group border border-gray-200 bg-gray-50 p-6 transition-all duration-700 ease-in-out hover:border-teal hover:shadow-xl hover:-translate-y-1">
              <h3 className="mb-3 text-base font-semibold text-gray-900">Why it matters</h3>
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <svg className="mt-0.5 h-4 w-4 flex-shrink-0 text-teal" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex items-center justify-center">
            <div className="w-full max-w-2xl border border-gray-200 bg-white shadow-sm transition-all duration-700 ease-in-out hover:border-teal/30 hover:shadow-2xl hover:-translate-y-1">
              {/* Tabs */}
                ...
                {activeTab === 'examples' ? (
                  <div className="space-y-6">
                    ...
                    <div>
                      <div className="mb-2 flex items-center gap-2">
                        ...
                        <label className="text-xs font-semibold uppercase tracking-wider text-teal">
                          AI OPTIMIZED OUTPUT
                        </label>
                      </div>
                      <div className="space-y-4 rounded-lg border border-teal/20 bg-teal/5 p-4 transition-all duration-500 hover:border-teal/40 hover:bg-teal/10 hover:shadow-md">
                        <div>
                          ...
                          <div className="flex flex-wrap gap-2">
                            {exampleData.tags.map((tag, index) => (
                              <span
                                key={index}
                                className="rounded-md bg-teal/10 px-3 py-1 text-xs font-medium text-teal transition-all duration-300 hover:bg-teal hover:text-white hover:scale-105 cursor-default"
                              >
                                {tag}
                              </span>
                            ))}
                  ...
                  <div className="space-y-6">
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full rounded-md border border-gray-300 bg-white px-4 py-3 text-sm text-gray-900 placeholder-gray-400 transition-all duration-300 hover:border-gray-400 focus:border-teal focus:outline-none focus:ring-2 focus:ring-teal/20"
                          />
                        </div>
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            rows={4}
                            className="w-full resize-none rounded-md border border-gray-300 bg-white px-4 py-3 text-sm text-gray-900 placeholder-gray-400 transition-all duration-300 hover:border-gray-400 focus:border-teal focus:outline-none focus:ring-2 focus:ring-teal/20"
                          />
                        </div>
                      </div>
                    </div>
                    ...
                    <button
                      ...
                      className="group flex w-full items-center justify-center gap-2 rounded-md bg-gray-900 px-6 py-3 text-sm font-semibold text-white transition-all duration-300 hover:bg-teal"
                    >
