                ...
                {activeTab === 'examples' ? (
                  ...
                  <div className="space-y-6">
                    ...
                    <button
                      ...
                      className="group flex w-full items-center justify-center gap-2 rounded-md bg-accent px-6 py-3 text-sm font-semibold text-white transition-all duration-300 hover:bg-[#000fd9]"
                    >
