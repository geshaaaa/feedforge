...
const stats = [
  {
    ...
    icon: (
      <svg className="h-6 w-6 text-teal/20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:items-center lg:gap-12">
          ...
          <div>
            ...
            <h2 className="mb-4 font-serif text-4xl font-bold leading-tight text-gray-900 lg:text-5xl xl:text-6xl">
              Search is Changing.{' '}
              <span className="text-teal">Irreversibly Fast.</span>
            </h2>
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-3 lg:grid-cols-1">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="relative border border-gray-200 bg-white p-3 shadow-sm transition-all duration-300 hover:border-teal/50 hover:shadow-md"
              >
                <div className="absolute right-2 top-2 opacity-20">
                  <div className="h-4 w-4">{stat.icon}</div>
                </div>
                <div className="mb-1 text-xl font-bold text-teal lg:text-2xl">
                  {stat.value}
                </div>
                <div className="mb-1 text-[10px] font-semibold uppercase tracking-wider text-gray-900">
                  {stat.category}
                </div>
          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:items-start mb-8">
            ...
            <div className="flex h-full flex-col border border-gray-200 bg-white p-6 shadow-sm">
              <div className="mb-4">
                ...
                <div className="flex items-center gap-3">
                  <span className="bg-teal/10 border border-teal/30 px-3 py-1 text-xs font-medium text-teal">
                    THE CHALLENGE
                  </span>
              ...
              <div className="mb-4 flex items-center gap-2 transition-all duration-300 hover:opacity-80 cursor-pointer">
                <svg className="h-5 w-5 text-teal transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  <div className="text-sm font-bold text-teal transition-colors duration-300">AT RISK</div>
                </div>
                <div className="ml-auto flex items-end gap-1">
                  <div className="h-8 w-2 bg-teal transition-all duration-300"></div>
                  <div className="h-6 w-2 bg-teal transition-all duration-300"></div>
                  <div className="h-4 w-2 bg-teal transition-all duration-300"></div>
                  <div className="h-3 w-2 bg-teal transition-all duration-300"></div>
                  <div className="h-2 w-2 bg-teal transition-all duration-300"></div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
                <div className="flex flex-col items-center justify-between border border-gray-200 bg-gray-50 p-3 text-center">
                  <div className="mb-2 text-xl font-bold text-teal">46%</div>
                ...
                <div className="flex flex-col items-center justify-between border border-gray-200 bg-gray-50 p-3 text-center">
                  <div className="mb-2 text-xl font-bold text-teal">77%</div>
                ...
                <div className="flex flex-col items-center justify-between border border-gray-200 bg-gray-50 p-3 text-center">
                  <div className="mb-2 text-xl font-bold text-teal">90M+</div>
            ...
            <div className="flex h-full flex-col border border-gray-200 bg-white p-6 shadow-sm">
              ...
              <div className="mb-4 flex items-center gap-2 transition-all duration-300 hover:opacity-80 cursor-pointer">
                ...
                <div>
                  <div className="text-xs text-gray-500 transition-colors duration-300">SYSTEM STATUS</div>
                  <div className="text-sm font-bold text-teal transition-colors duration-300">OPTIMIZED</div>
                </div>
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
                <div className="flex flex-col items-center border border-gray-200 bg-white p-3 text-center">
                  <svg className="mb-2 h-5 w-5 text-teal" fill="none" stroke="currentColor" viewBox="0 0 24 24">
